...
sudo curl -fSL "$AND/v1.3.3/DarkPrinceVPN-1.3.3.apk" \
     -o /srv/darkprince/site/downloads/DarkPrinceVPN.apk

sudo curl -fSL "$WIN/v1.3.1/DarkPrinceVPN-1.3.1-setup.exe" \
     -o /srv/darkprince/site/downloads/DarkPrinceVPN-setup.exe

sudo curl -fSL "$LIN/v1.3.1/DarkPrinceVPN-1.3.1-x86_64.pkg.tar.zst" \
     -o /srv/darkprince/site/downloads/DarkPrinceVPN.pkg.tar.zst
sudo curl -fSL "$LIN/v1.3.1/DarkPrinceVPN-1.3.1-amd64.deb" \
     -o /srv/darkprince/site/downloads/DarkPrinceVPN.deb
sudo curl -fSL "$LIN/v1.3.1/DarkPrinceVPN-1.3.1-x86_64.AppImage" \
...
sudo curl -fSL "$WIN/v1.3.1/windows-x86_64.json" \
     -o /srv/darkprince/site/updates/windows-x86_64.json
sudo curl -fSL "$LIN/v1.3.1/linux-x86_64.json" \
     -o /srv/darkprince/site/updates/linux-x86_64.json
sudo curl -fSL "$AND/v1.3.3/android.json" \
